<template>
  <div class="home-page">
    <header>
      <h1>Welcome to My TypingApp</h1>
    </header>
    <main>
      <p>Improve your typing skills with our practice.</p>
      <div class="button-container">
        <button class="button" @click="startPracticing">
          ...
          <span class="text_button">Start Typing</span>
        </button>
      </div>
    </main>
  </div>
...
const setUsername = async (userId) => {
  try {
